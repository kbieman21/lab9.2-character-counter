...
function StatsDisplay({ stats, showReadingTime }: StatsDisplayProps) {
  ...
  }else if (wordCount > 2 && wordCount < 101){
    showReadingTime = true;
  }else{
    //alert('Words are too short or too long')
  }
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 min-h-screen p-6 space-y-6">
      <div >
        <TextInput onTextChange={handleTextChange} placeholder="Start typing here" />
      </div>
